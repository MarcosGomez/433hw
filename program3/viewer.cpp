...
void init ( void )
{
	...
	<<":"<<ksVector.size()<<":"<<nsVector.size()<<endl;
...
void display (void )
{
	...
	glUseProgram( classicProgram );
	for(int i = 0; i < numOfObjects; i++){
		// cout<<"numVertices: "<<numVertices[i]<<" objectOffset: "<<objectOffset[i]<<endl;
...
void readObj(const char * fileName){
	...
	std::vector< glm::vec2 > tempUvs;//Not implemented
