...
uniform sampler2D tex; //Default is 0. Only needs to change with multiple textures
...
void main()
{
    ...
    for (int light = 0; light < MAXLIGHTS; ++light) 
	{
        ...
        scatteredLight += Lights[light].ambient * ambient * attenuation +
                          Lights[light].color * (diffuseCoeff * finalDiffuse) * attenuation;
